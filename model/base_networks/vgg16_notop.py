...
def VGG16(
        ...
        #block3
        conv3_1 = Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv1',
                         kernel_initializer=kernel_initializer, kernel_regularizer=kernel_regularizer)(pool2)
        conv3_2 = Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv2',
                         kernel_initializer=kernel_initializer, kernel_regularizer=kernel_regularizer)(conv3_1)
        conv3_3 = Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv3',
        ...
        #block4
        conv4_1 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv1',
                         kernel_initializer=kernel_initializer, kernel_regularizer=kernel_regularizer)(pool3)
        conv4_2 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv2',
                         kernel_initializer=kernel_initializer, kernel_regularizer=kernel_regularizer)(conv4_1)
        conv4_3 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv3',
        ...
        #block5
        conv5_1 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv1',
                         kernel_initializer=kernel_initializer, kernel_regularizer=kernel_regularizer)(pool4)
        conv5_2 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv2',
                         kernel_initializer=kernel_initializer, kernel_regularizer=kernel_regularizer)(conv5_1)
        conv5_3 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv3',
                         kernel_initializer=kernel_initializer, kernel_regularizer=kernel_regularizer)(conv5_2)
        pool5 = MaxPooling2D((2, 2), strides=(2, 2), name='block5_pool', padding='same')(conv5_3)
